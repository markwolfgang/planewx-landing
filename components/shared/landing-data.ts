...
}[] = [
  {
    ...
    a: [
      ...
      [
        ...
        ", and mentors who see the same briefing you see. You can also ",
        {
          href: "https://app.planewx.ai/help",
          label: "share a flight plan into PlaneWX",
        },
        " from the one major EFB that supports that share action today.",
      ],
