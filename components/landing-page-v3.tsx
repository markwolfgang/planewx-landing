          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative p-7 sm:p-8 rounded-3xl bg-gradient-to-br from-blue-950/60 to-blue-950/20 border border-blue-500/20">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                ...
                the WX Score cannot generate without them, and they appear on every briefing.
              </p>
            </div>
            ...
            <div className="relative p-7 sm:p-8 rounded-3xl bg-gradient-to-br from-violet-950/60 to-violet-950/20 border border-violet-500/20">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                ...
                and trip context so you are not inventing the environment under pressure.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "HRRR, GFS, and ECMWF consensus across 3 to 7 sample points along your route, with confidence scoring on the agreement.",
              },
              {
