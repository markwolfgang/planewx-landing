...
const TESTIMONIALS = [
  {
    quote:
      "I've been beta testing this product for a few weeks now and I'm really enjoying it. It does a very good job of synthesizing multiple weather products and highlighting the key factors to be aware of. It links everything back to the source data so you can verify if anything looks amiss.",
    name: "Adam",
    cert: "Private",
  },
  {
    quote:
      "This tool has a great flow to it, and tells me what I want to know. I'm by no means a weather geek. I'm looking to assess risk. This looks promising.",
    name: "Vas",
    cert: "Instrument Rated",
  },
  {
    quote:
      "I just signed up a couple of days ago and super impressed. This is way better than other solutions I use mainly because it interprets the weather and gives me conclusions.",
    name: "Sukumar",
    cert: "Commercial",
  },
  {
    quote:
      "Very impressive and helpful. Great use of A.I. I can relate to your comments about going to many different websites piecing things together.",
    name: "Forrest",
    cert: "ATP",
  },
  {
    quote:
      "I've been using this for several weeks. For big trips that are a week away it helps me stay aware of the outlook and sometimes highlights things that I'm not seeing. I like it.",
    name: "Roy",
    cert: "Instrument Rated",
  },
  {
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. The free plan includes 2 active flights, full WX Score breakdowns, personal minimums, PAVE risk assessment, 14-day planning, and the ability to broadcast a help request to volunteer mentors. The Pro plan adds auto-refresh, email alerts, Trip Watchers, Corridor Watch, Multi-City Optimizer, and mentor directory access.",
  },
]
