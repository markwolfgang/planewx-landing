  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-white overflow-hidden">
      ...
      <div
        ...
        style={{
          background: [
            "radial-gradient(ellipse 600px 600px at 25% 0%, rgba(16,185,129,0.10) 0%, transparent 70%)",
            "radial-gradient(ellipse 500px 500px at 75% 100%, rgba(20,184,166,0.10) 0%, transparent 70%)",
            "radial-gradient(ellipse 400px 400px at 50% 50%, rgba(16,185,129,0.05) 0%, transparent 70%)",
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-5 gap-10 items-start">
            ...
            <div className="md:col-span-3 space-y-5 text-white/60 leading-relaxed">
              ...
              <p>
                Now flying a TBM 900 and over 1,000 hours total time, Mark built PlaneWX to solve his own problem. What
              ...
              <div className="pt-4 border-t border-white/10 space-y-3">
                ...
                <p className="text-sm text-white/50">
                  ...
                  <a href="/about" className="text-emerald-400 hover:text-emerald-300 underline underline-offset-2">
                    About
                  </a>{" "}
