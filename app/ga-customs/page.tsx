...
const SCREENSHOTS = [
  {
    ...
    alt: "GA Customs Map — Presidio Lely International (KPRS) selected with filters",
    label: "Map",
  },
  {
    src: "/ga-customs/02-kprs-hours.png",
    alt: "KPRS detail — operating hours, permission to land, and inspection process",
    label: "Hours",
  },
  {
    src: "/ga-customs/03-kprs-process-reviews.png",
    alt: "KPRS — inspection process, pilot reviews, and offline PDF",
    label: "Process & reviews",
  },
  {
    src: "/ga-customs/04-favorites.png",
    alt: "Favorites — saved Airports of Entry with status colors",
    label: "Favorites",
  },
  {
    src: "/ga-customs/05-about.png",
    alt: "About — GA Customs version, appearance, and data freshness",
    label: "About",
  },
] as const
    ...
    <div className="min-h-screen bg-[#0B1120] text-white">
      ...
      */}
      ...
      <main className="container mx-auto max-w-5xl px-4 py-12 sm:py-16 space-y-14 sm:space-y-20">
        {/* Hero — short-final app icon + GA Customs wordmark */}
        ...
        <section className="space-y-6" aria-labelledby="ga-customs-shots">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-white/55 leading-relaxed">
              Map through About — the same screens you&apos;ll open when GA Customs
