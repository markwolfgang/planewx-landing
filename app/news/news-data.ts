...
`,
  },
  {
    ...
    excerpt:
      "Verified PlaneWX Pro Plus members are eligible for risk-based premium credits through 5X5's Safety Rewards program. 5X5 can ask if a tail they already insure is on PlaneWX Pro Plus. If yes, they get briefing usage for that tail. We do not share briefings, scores, or whether you flew, and we do not send them our customer list.",
    date: "August 17, 2026",
    isoDate: "2026-08-17",
    location: "St. Petersburg, Florida",
    coBrand: {
    ...
    body: `
<p><strong>St. Petersburg, Florida &mdash; August 17, 2026 &mdash;</strong> PlaneWX, the pilot&rsquo;s decision support system, today named <a href="https://www.5x5insurance.com" target="_blank" rel="noopener noreferrer">5X5 Aviation Insurance</a> its exclusive insurance partner. Verified PlaneWX Pro Plus members are eligible for risk-based premium credits through 5X5&rsquo;s Safety Rewards program &mdash; recognition, in the underwriting process, of the preparation pilots already do before they fly. <a href="/privacy#insurance-partners">5X5 can ask if a tail they already insure is on PlaneWX Pro Plus. If yes, they get briefing usage for that tail. We do not share briefings, scores, or whether you flew, and we do not send them our customer list.</a></p>
...
<p>The partnership rewards using the process. <a href="/privacy#insurance-partners">5X5 can ask if a tail they already insure is on PlaneWX Pro Plus. If yes, they get briefing usage for that tail. We do not share briefings, scores, or whether you flew, and we do not send them our customer list.</a></p>
...
`,
  },
  {
    ...
    excerpt:
      "A new plan for pilots who fly enough that the briefing should follow the airplane — Ground Protection, Auto-Brief, a pre-flight text, and eligibility for 5X5's risk-based premium credits. 5X5 can ask if a tail they already insure is on PlaneWX Pro Plus. If yes, they get briefing usage for that tail. We do not share briefings, scores, or whether you flew, and we do not send them our customer list.",
    date: "August 17, 2026",
    isoDate: "2026-08-17",
    location: "St. Petersburg, Florida",
    body: `
