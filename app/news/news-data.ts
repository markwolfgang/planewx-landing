...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    excerpt:
      "Compassion Flight volunteer pilots can unlock PlaneWX Pro Plus with a call sign, start a free trial, and get 30% off an annual plan, every year they remain an active volunteer pilot. We re-confirm the call sign once a year. The partnership puts decision support behind the pilots who fly for those in need.",
...
<p>Eligible pilots start at <a href="https://www.planewx.ai/volunteer?ref=ACA">www.planewx.ai/volunteer?ref=ACA</a>. A Compassion Flight call sign unlocks signup. The two-week Pro Plus trial begins from there. When the pilot continues on Pro Plus annual, they get 30% off an annual plan, every year they remain an active volunteer pilot. We re-confirm the call sign once a year. There is no promo code to type. More on the partnership and other collaborators is at <a href="https://www.planewx.ai/partners">www.planewx.ai/partners</a>.</p>
...
`,
  },
  {
    ...
    excerpt:
      `Verified PlaneWX Pro Plus members are eligible for risk-based premium credits through 5X5's Safety Rewards program. ${FIVE_X_FIVE_SEES_LINE}`,
    date: "August 17, 2026",
    isoDate: "2026-08-17",
    location: "St. Petersburg, Florida",
    coBrand: {
    ...
    body: `
<p><strong>St. Petersburg, Florida &mdash; August 17, 2026 &mdash;</strong> PlaneWX, the pilot&rsquo;s decision support system, today named <a href="https://www.5x5insurance.com" target="_blank" rel="noopener noreferrer">5X5 Aviation Insurance</a> its exclusive insurance partner. Verified PlaneWX Pro Plus members are eligible for risk-based premium credits through 5X5&rsquo;s Safety Rewards program &mdash; recognition, in the underwriting process, of the preparation pilots already do before they fly. <a href="/privacy#insurance-partners">${FIVE_X_FIVE_SEES_LINE}</a></p>
