...
<p>Eligible pilots start at <a href="https://www.planewx.ai/volunteer?ref=ACA">www.planewx.ai/volunteer?ref=ACA</a>. A Compassion Flight call sign unlocks signup. The two-week Pro Plus trial begins from there. When the pilot continues on Pro Plus annual, 30% off the first year applies automatically from the stored call sign. There is no promo code to type. More on the partnership and other collaborators is at <a href="https://www.planewx.ai/partners">www.planewx.ai/partners</a>.</p>
