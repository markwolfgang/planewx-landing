      ...
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-24">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-xl text-white/60 max-w-3xl mx-auto leading-relaxed">
            ...
            and government advisories. You get altitude-specific icing and turbulence intelligence 
            for the route you plan to fly.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl bg-amber-500/5 border border-amber-500/20">
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                ...
                <li className="flex items-start gap-3">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5 shrink-0" />
                  <span>Don&rsquo;t tell you where the clouds actually are</span>
                </li>
                <li className="flex items-start gap-3">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5 shrink-0" />
            ...
            <div className="p-6 rounded-2xl bg-amber-500/5 border border-amber-500/20">
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                <li className="flex items-start gap-3">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5 shrink-0" />
                  <span>Depend on other pilots filing reports, with huge coverage gaps at night and in rural areas</span>
                </li>
                <li className="flex items-start gap-3">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5 shrink-0" />
        ...
        <section className="space-y-8">
          ...
          <div className="p-6 rounded-2xl bg-sky-500/5 border border-sky-500/20 text-center">
            <p className="text-white/80">
              <strong className="text-sky-400">PlaneWX synthesizes these sources into one assessment.</strong> Many tools show 
              model overlays, G-AIRMETs, and PIREPs as separate layers. PlaneWX combines them into a single, coherent 
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="container mx-auto max-w-5xl px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/30">
            ...
            You&rsquo;re the pilot in command. PlaneWX informs the decision; you make the call.
          </p>
        </div>
      </footer>
    </div>
