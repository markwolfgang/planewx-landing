...
export const LEARN_ARTICLES: LearnArticle[] = [
  ...
  },
  {
    ...
    puttingItIntoPractice: {
      ...
      toolOrHabit:
        "Brief early and re-brief as the flight gets closer, using the PlaneWX Weather Briefing with a WX Score against your personal minimums. That supports the Fly or Stay step without telling you which way to call it.",
    },
    sources: [
      {
